...
export class ClickerModel extends Reactive {
    constructor() {
        ...
        setInterval(() => {
            for (const bot in this.bots) {
                this.clicks += this.bots[bot].increment * this.bots[bot].purchase * this.multiplier;
            }
        }, 10000);
    ...
    increment(inc) {
        ...
        if (
            ...
            this.bus.trigger("MILESTONE", this.milestones[this.level]); // truyền giá this.milestones[this.level] cho bên clicker_service.js
            this.level++;
        }
    }
